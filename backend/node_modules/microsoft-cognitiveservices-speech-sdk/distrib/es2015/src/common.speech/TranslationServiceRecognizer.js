            ...
            case "translation.phrase":
                ...
                if (translatedPhrase.RecognitionStatus === RecognitionStatus.Success) {
                    ...
                    if (reason === ResultReason.Canceled) {
                        ...
                        const ev = new TranslationRecognitionCanceledEventArgs(this.privRequestSession.sessionId, cancelReason, null, cancelReason === CancellationReason.Error ? CancellationErrorCode.ServiceError : CancellationErrorCode.NoError, result);
